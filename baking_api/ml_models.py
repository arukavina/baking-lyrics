...
logger = log_utils.get_logger('bl-baking_api')
...
if __name__ == '__main__':
    ...
    log_utils.setup_logging('bl-baking_api-mlAbl', timestamp, settings)
    logger = log_utils.get_logger('bl-baking_api-mlAbl')
